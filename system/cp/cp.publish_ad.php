...
//=====================================================================
    ...
    {  
       ...
       {
			$_POST['field_related_id'] =  $_POST['field_related_blog_id'];
       }
       else
       {
			$_POST['field_related_id'] =  $_POST['field_related_gallery_id'];
       }
        ...
        else
        {
            ...
            else
            {
				...
				$DB->query("ALTER TABLE exp_weblog_data ADD COLUMN field_ft_".$insert_id." varchar(40) NOT NULL default 'xhtml'");
    ...
    function edit_upload_preferences_form()
    {
        ...
        $DSP->crumb = $DSP->anchor(BASE.AMP.'C=admin'.AMP.'area=weblog_administration', $LANG->line('weblog_administration')).
        			  ...
        			  $DSP->crumb_item($LANG->line('create_new_upload_pref'));
        $DSP->body  = $r;
    }
    /* END */
