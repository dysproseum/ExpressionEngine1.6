...
DOH;
    ...
    function wiki_module_install()
    {
        ...
        $sql[] = "INSERT INTO exp_modules (module_id, module_name, module_version, has_cp_backend) VALUES (0, 'Wiki', '$this->version', 'y')";
		...
		last_revision_id INT(10) NOT NULL DEFAULT 0,
