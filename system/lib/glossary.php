...
$glossary[1][] = array('italic',			'<italic></italic>');
...
$glossary[2][] = array('font',	'<style="font-face: Verdana; font-size:11px; color:#000;">');
$glossary[2][] = array('unordered_list',	'<ul><li></li></ul>');
$glossary[2][] = array('ordered_list',		'<ol><li></li></ol>');
